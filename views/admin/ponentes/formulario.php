<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Informarcion Personal </legend>
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Informarcion Personal Extra </legend>

    <div class="formulario__campo">
        <label for="tags_input" class="formulario__label">Areas De Experiencia (Separadas por coma)</label>
        <input type="text" id="tags_input" class="formulario__input" placeholder="Ej. Node.js, PHP, CSS, Laravel">
