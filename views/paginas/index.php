...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de DevWebcam</p>
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div  data-aos="<?php aos_animacion(); ?>" class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen"  width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Ponente">
                </picture>
...
<section class="boletos">
    <h1 class="boletos__heading">Boletos y Precios</h1>
    <p class="boletos__descripcion">Precios para DevWebcam</p>
