<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            <a href="/">
                <h1 class="header__logo">&#60;DevWebcam/></h1>
            </a>
            <p class="header__texto">Octubre 29-30 - 2023</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            <a href="/devwebcam" class="navegacion__enlace <?php echo pagina_actual('/devwebcam') ? 'navegacion__enlace--actual' : '' ?>">Evento</a>
